About imgaug-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/imgaug-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6868&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/imgaug-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `imgaug` can be installed with `conda`:
...
It is possible to list all of the versions of `imgaug` available on your platform with `conda`:
...
```
mamba search imgaug --channel conda-forge
```
...
mamba repoquery search imgaug --channel conda-forge

# List packages depending on `imgaug`:
mamba repoquery whoneeds imgaug --channel conda-forge

# List dependencies of `imgaug`:
mamba repoquery depends imgaug --channel conda-forge
```
